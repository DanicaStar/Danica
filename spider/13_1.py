'''
url='https://food.hiyd.com/',食物的名字，及其热量信

谷物：https://food.hiyd.com/list-1-html
蛋制品：https://food.hiyd.com/list-2-html
    第二页：https://food.hiyd.com/list-1-html?page=2
'''
...
def savedata(li): #定义写入数据的函数
    try:
        wb = load_workbook("13_result.xlsx")
    except:
        wb = Workbook()
    finally:
        try:
